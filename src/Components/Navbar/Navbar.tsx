      ...
      <div className="mx-auto max-w-[1400px] px-4 sm:px-6">
        <div className="flex h-16 items-center justify-between gap-4">
            ...
            {navLinks.map(({ to, label }) => (
              <li key={to}>
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `group relative flex items-center gap-1 whitespace-nowrap rounded-lg px-2.5 py-2 text-sm font-semibold transition-colors hover:text-slate-900 dark:hover:text-slate-100 ${
          ...
          <div className="flex items-center gap-3">
            ...
            {/* Language toggle */}
            <button
              className="hidden h-9 items-center gap-1.5 rounded-full border border-slate-300 bg-slate-100 px-2.5 text-xs font-semibold text-slate-600 shadow-e1 transition-colors hover:bg-white sm:flex dark:border-slate-700 dark:bg-slate-800/60 dark:text-slate-300 dark:hover:bg-slate-800"
              onClick={toggleLang}
            ...
            <button
              ...
              className="hidden h-9 w-9 items-center justify-center rounded-full border border-slate-300 bg-slate-100 text-slate-600 shadow-e1 transition-colors hover:bg-white dark:border-slate-700 dark:bg-slate-800/60 dark:text-slate-300 dark:hover:bg-slate-800 sm:flex"
            >
            ...
            {!isAuthenticated ? (
              ...
              <>
                ...
                <div className="relative" ref={dropdownRef}>
                  <button
                    className="flex items-center gap-2 rounded-xl border border-slate-300 bg-slate-100 px-2.5 py-1.5 shadow-e1 transition-colors hover:border-blue-200 hover:bg-white dark:border-slate-700 dark:bg-slate-800 dark:hover:border-blue-500"
